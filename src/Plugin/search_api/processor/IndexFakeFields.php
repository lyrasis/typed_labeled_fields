...
namespace Drupal\typed_labeled_fields\Plugin\search_api\processor;
 ...
 /**
 * Thanks to Mark Jordan's Fake Fields module as inspiration and a guide for the 
 * general outline of this code https://github.com/mjordan/fakefields .
 */
...
class IndexFakeFields extends ProcessorPluginBase implements PluginFormInterface {
  ...
  public function buildConfigurationForm(array $form, FormStateInterface $form_state): array
  {
    ...
    $form['#description'] = 'This processor will generate fake fields based on the type of the field and the label of the field.';
    $markup = 'If this fails to compile by not filling in the input field boxes go to <a href="/admin/help/typed_labeled_fields">Typed labeled fields Help Page</a> for more information.';
    $form['field_index_fake_fields_description'] = [
        '#type' => 'markup',
        '#markup' => $markup,
        '#weight' => -1,
    ...
    $form['fake_fields_source'] = [
      '#type' => 'textarea',
      '#title' => $this->t('Machine names of the Drupal fields of the type "typed_labeled_text_short". These fields should be of type "Typed Labeled Text (plain)". '),
    ...
    $form['fake_fields'] = [
      ...
      '#description' => $this->t('These should automatically pull in once when compiling Solr field names. Click button to compile. Adding values here manually is not advised but can be done if you want to add a new field.'),
    ...
    $form['fake_fields_fetch'] = [
      '#type' => 'submit',
      '#value' => t('Discovery & Compile Solr field names'),
      '#prefix' => '<br><div class="form-item">',
      '#suffix' => '</div>This will compile the "Prefix" with the discovered fields and will overwrite the "List of Solr field names generated by Identifier Types + Label". Any custom values in these fields will be lost.<br/>',
    ...
    $form['resetForm'] = [
      ...
      '#value' => t('Reset'),
      '#prefix' => '<br><div class="form-item">',
      '#suffix' => '</div>This will reset the form and remove all compiled fields. Any custom values in these fields will be lost.',
      '#submit' => [[$this, 'reset']],
      ];

      $form['#validate'][] = 'validateForm';
      $form['#attached']['library']['typed_labeled_fields'] = 'css/typed_labeled_fields.field.admin';
